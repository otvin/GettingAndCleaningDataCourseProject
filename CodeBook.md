...
The complete list of variables of each feature vector are listed in the features_info.txt file that can be found in the `UCI HAR Dataset` folder and can be obtained as described in the README.md.
